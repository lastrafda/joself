<template>
  <div class="py-8 text-gray-900">
      <div class="text-center sm:text-right font-bold italic text-3xl pb-8">If<span class="text-yellow-600"> --</span> By Rudyard Kipling</div>
      <div>
      ...
      <div>
        ...
        <p class="font-bold text-gray-900">If you can meet with Triumph and Disaster</p>
        <p class="font-bold text-yellow-700">And treat those two impostors just the same;</p>
